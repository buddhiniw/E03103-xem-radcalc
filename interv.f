...
C
C Stolen by J. Arrington, from netlib routines from pppack
C (http://www.netlib.org/pppack/interv.f  (part of ppvalu.f package).
C modified to take real*8 variables
C
