...
!	alpha=real(alpha1)
	...
	bg=bg*1000
	  ...
	  cgd =   0.41675E+00
	  dgd =   0.13772E+02
        elseif ((aa .eq. 56).or.(aa.eq.63))then      !iron
	  agd =   0.28316E+01
	  bgd =    0.44624E+02
	  cgd =    0.37850E+00
	  dgd =    0.12003E+02
...
!	    write(*,*) 'my nu is ', nu, wp**2, q2, rq2
	    ...
	    call F1F2IN06(1.,1.,rq2,wp**2,w11,w22)
...
!       errorinBR	arg21 = (1. - p*u*q2/amp/anup/q3)*anup*anup/anu/anu
	    ...
	    w11=0.
	    w22=0.
	    call F1F2IN06(0.,1.,rq2,wp**2,w11,w22)
	    if((w11.eq.0).or.(w22.eq.0)) goto 10
	    w11=w11/amp
	    w22=w22/nu
...
!	  write(12,*) 'weight ', p, weight1, weight2
!	  weight1=weight2
