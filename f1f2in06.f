...
! Calculate dueteron F1 by Fermi smearing of proton plus neutron 
      implicit none
      real*8 q2,w2,w1,wsq,xbj,xval(50),F1,am/0.9383/,nu,qv,dw2dpf,w2p,sigp
      real*8 sigtst,amd/1.8756/, pz
...
c we don't want to go to higher x values since we know nmc f2n/f2p is for "bound" LD2.
c Following limits are sort of arbitrary but hopefully we suffer only  
c minimal damage in transition     
